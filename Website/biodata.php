...
<body>
    ...
    <section class="registrasi-section spad">
        <div class="container container-form">
            <div class="card">
                <h1 class="card-title" align="center">Profil Pengguna</h1>
                <div class="card-body">
                    <form action="#" method="post">

                        <br>
                        <input type="text" class="form-control" placeholder="Nama Lengkap" autocomplete="off"
                            name="nama"><br>
                        <input type="text" class="form-control" placeholder="Alamat" autocomplete="off"
                            name="alamat"><br>
                        <input type="text" class="form-control" placeholder="Nomor HP" autocomplete="off"
                            name="nomor_hp"><br>
